...
class UserService {
    ...
    suspend fun createMockUsers() = withContext(Dispatchers.IO) {
        val user1 = User(nickname = "tester1", age = 12, profileImg = entityManager.getReference(Image::class.java, 1.toLong()), postings = null)
        val user2 = User(nickname = "tester2", age = 13, profileImg = entityManager.getReference(Image::class.java, 2.toLong()), postings = null)
        val user3 = User(nickname = "tester3", age = 14, profileImg = entityManager.getReference(Image::class.java, 3.toLong()), postings = null)
        val user4 = User(nickname = "tester4", age = 20, profileImg = entityManager.getReference(Image::class.java, 4.toLong()), postings = null)
